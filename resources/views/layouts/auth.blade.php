...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/svg/logo.svg') }}" type="image/png" />
    ...
    <title>Auth | E - Ticketing</title>
</head>

<body style="background-image: url({{ asset('assets/images/main-background.png') }});background-size:cover;background-position:center;height: 100vh;background-repeat: no-repeat;">
    <div class="wrapper">
        <div class="my-5 section-authentication-signin d-flex align-items-center justify-content-center">
            <div class="container-fluid">
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="mx-auto col">
                        <div class="shadow-sm card radius-15">
                            <div class="card-body">
                                <a href="{{ route('home') }}" class="mb-4 text-start d-block text-dark fs-6">
                                    <i class='bx bx-left-arrow-alt' ></i>
                                    Kembali
                                </a>
                                <div class="p-4 rounded">
                                    <div class="mb-4 text-center">
                                        <svg id="logo-88" width="50" height="50" viewBox="0 0 40 41"
                        ...
                        <div class="pt-5 text-center">
                            <small>
                                <p class="m-0">Dibuat oleh <a href="https://syaddad.pages.dev" style="color: #FF630B;">Syaddad Raihan Putra</a></p>
                                <p class="text-uppercase">untuk memenuhi syarat kompetensi USK <br/>Skema Okupasi Asisten Pemrogram Junior</p>
                            </small>
                        </div>
                    </div>
                </div>
