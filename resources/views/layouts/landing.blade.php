...
<head>
    ...
    <title>E - Ticketing | Official</title>
</head>
...
<body>
        ...
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <div class="gap-3 d-flex align-items-center">
                    ...
                    <span class="fw-bold text-light">E-Ticketing</span>
                </div>
            </a>
            ...
            <div class="gap-2 collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="{{ route('register') }}" class="px-3 btn btn-primary rounded-pill">Daftar</a>
                <a href="{{ route('login') }}" class="px-3 btn btn-outline-primary rounded-pill">Masuk</a>
            </div>
        </div>
    </nav>
    ...
    <footer class="py-2 text-center bg-white w-100">
