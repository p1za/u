                            ...
                            <tbody>
                                @forelse ($bookings as $booking)
                                    <tr>
                                        ...
                                        <td>±{{ \Carbon\Carbon::parse($booking->schedule->departure_time)->diffInMinutes(\Carbon\Carbon::parse($booking->schedule->arrival_time)) }}
                                            menit</td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger rounded-pill btn-sm" {{ $booking->status !== 'diproses' ? 'disabled' : '' }}
                                            ...
                                            <div class="modal fade" id="editModal{{ $booking->id }}" tabindex="-1"
                                                aria-labelledby="editModal{{ $booking->id }}Label" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModal{{ $booking->id }}Label">
                                                                Batalkan Pemesanan</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form
                                                            action="{{ route('passenger.my-bookings.cancel', $booking->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
